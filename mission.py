...
class Controller:
    ...
    def x_dir(self):
    	self.sp.position.x = self.local_pos.x + 10
    	self.sp.position.y = self.local_pos.y
        self.sp.position.z = self.local_pos.z
    ...
    def y_dir(self):
    	self.sp.position.x = self.local_pos.x
    	self.sp.position.y = self.local_pos.y + 10
        self.sp.position.z = self.local_pos.z
    ...
    def z_dir(self):
        self.sp.position.x = self.local_pos.x
    	self.sp.position.y = self.local_pos.y
        self.sp.position.z = self.local_pos.z + 10
...
def main():
    ...
    # ROS main loop
    x='a'
    while ((not rospy.is_shutdown())and x != 'q'):
